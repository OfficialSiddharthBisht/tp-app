export const demoQuestions = [
  {
    question:
      "In the early 19th century, the Industrial Revolution was transforming the landscape of Britain. Factories were springing up in cities and towns, and the demand for coal and iron was increasing. This period saw significant advancements in technology and engineering, which led to the development of new machinery and the expansion of the railway network. However, this rapid industrialization also brought about social and economic changes. Many people moved from rural areas to urban centers in search of work, leading to overcrowded and unsanitary living conditions. Despite these challenges, the Industrial Revolution played a crucial role in shaping modern Britain.",
    options: [
